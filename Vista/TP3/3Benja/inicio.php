    ...
    <main class="container mt-5">
        <section class="card shadow p-4">
            <form class="needs-validation" novalidate action="procesar.php" id="loginForm" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                        <label for="validacionArchivo" class="form-label">Imagen</label>
                        <input type="file" id="validacionArchivo" name="validacionArchivo" class="form-control" required>
                        <div class="invalid-feedback" id="archivoError"></div>
                        <div class="valid-feedback" id="archivoValido"></div>
                </div>
