...
// Validacion campo archivo
        // Obtengo lo necesario para validar
    const inputArchivo = document.getElementById("validacionArchivo");
    const errorArchivo = document.getElementById("archivoError");
    const aciertoArchivo = document.getElementById("archivoValido");
    ...
    if (inputArchivo.files.length === 0) {
        ...
        if (!allowedExtensions.includes(extension)) {
            event.preventDefault();
            inputArchivo.classList.add("is-invalid");
            errorArchivo.textContent = "Solo se aceptan archivos .jpg, .jpeg, .png.";
        } else {
